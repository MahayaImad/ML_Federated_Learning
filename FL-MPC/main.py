...
from comparison.fl_vs_mpc import compare_fl_vs_mpc, plot_comparison
...
def main():
    ...
    parser.add_argument('--rounds', type=int, default=30, help='Nombre de tours')
    ...
    if args.plot and results['mpc'] is not None:
